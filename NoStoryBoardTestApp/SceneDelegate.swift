...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createDashboardNC() -> UINavigationController {
        ...
        dashboardVC.tabBarItem = UITabBarItem(title: "Dashboard", image: UIImage(systemName: "list.dash"), selectedImage: UIImage(systemName: "list.dash"))
        
        return UINavigationController(rootViewController: dashboardVC)
    }
    
    func createExpensesNC() -> UINavigationController {
        let expensesVC = ExpensesVC()
        expensesVC.title = "Expenses"
        expensesVC.tabBarItem = UITabBarItem(title: "Expenses", image: UIImage(systemName: "list.dash"), selectedImage: UIImage(systemName: "list.dash"))
